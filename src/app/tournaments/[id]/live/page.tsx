...
function LivePlayersTab({ players }: { players: Player[] }) {
  ...
  return (
    <div>
      {/* Table Header */}
      <div className="grid grid-cols-[3rem_1fr_5rem] items-center border-b border-gray-200 px-4 py-2 text-xs font-medium uppercase tracking-wider text-gray-400">
        <span>No.</span>
        <span>Name</span>
        <span>Gender</span>
      </div>
      ...
      {players.map((player, index) => (
        <div
          key={player.id}
          className="grid grid-cols-[3rem_1fr_5rem] items-center border-b border-gray-100 px-4 py-4"
        >
